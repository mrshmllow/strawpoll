...
const Privacy: React.FC = () => (
  <Main>
    ...
    <div className="text-left">
      <h1 className="text-2xl text-slate-900 dark:text-slate-200 sm:text-3xl text-center mb-2">Privacy Policy</h1>

      <h2 className="text-xl text-slate-900 dark:text-slate-200 sm:text-2xl">Consuming polls</h2>
      <p className="mb-2">We collect your IP only when voting on a poll so that we can eliminate duplicate votes and trolls. All records are deleted once the poll is deleted. We also store a cookie on your device, to reduce server pressure. The creator of the poll cannot see who you are or your IP.</p>

      <h2 className="text-xl text-slate-900 dark:text-slate-200 sm:text-2xl">Creating polls</h2>
      <p className="mb-2">We store no information about you if you create a poll.</p>
